                                                ...
                                                <div class="book-item">
                                                    <a href="{{ route('front.book.show', $book->id) }}" >
                                                        <img src="{{ $book->photo }}" alt="{{ $book->title }}"
                                                            class="img-fluid">
                                                        <h6 class="book-title mt-2" alt="{{ $book->title }}">{{ Str::limit($book->title, 15) }}</h6>
                                                    </a>
                                                    <div class="book-meta">
                                                        <span class="views">Lượt xem: {{ number_format($book->views) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @foreach ($recentBooks as $book)
                                            <div class="col-md-2">
                                                <div class="book-item">
                                                    <a href="{{ route('front.book.show', $book->slug) }}" class="text-dark text-decoration-none book-link" data-book-id="{{ $book->id }}">
                                                        <img src="{{ $book->photo }}" alt="{{ $book->title }}"
                                                            class="img-fluid">
                                                        <h6 class="book-title mt-2" alt="{{ $book->title }}">{{ Str::limit($book->title, 15) }}</h6>
                                                    </a>
